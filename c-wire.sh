...
# Application du filtrage des consommateurs
...
cd codeC 
./c-wire "../$final_output_file" "../$aggregated_output_file"
cd ..
...
echo "Le fichier final est disponible dans : $aggregated_output_file"
